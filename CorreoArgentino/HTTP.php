...
class Http
{
    ...
    /**
     * Código de error CURL y mensaje informativo.
     * @var array
     */    
    protected $response_error;
    
    /**
     * Información sobre la petición HTTP.
     * @var array
     */
     ...
     * @var string
     */
    protected $header_content_type = 'content-type: application/x-www-form-urlencoded';    
    ...
    public function delete($url, $data = array(), $headers = array(), $options = array())
    {
    ...
    protected function request($method, $url, $data = array(), $headers = array(), $options = array())
    {
        $curl = curl_init();
        ...
        if ($add_content_type_header) {
            $headers[] = $this->header_content_type;
        }
        ...
        if ($options) {
            foreach ($options as $option_id => $option_value) {
                curl_setopt($curl, $option_id, $option_value);
            }
        }
